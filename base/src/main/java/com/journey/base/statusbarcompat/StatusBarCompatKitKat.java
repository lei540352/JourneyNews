...
//        }
     ...
     *
     * * 1.设置窗口标志：WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS
     *       * 2.将FitsSystemWindows设置为视图。
     *       * 3.添加工具栏的高度，使其从顶部开始布局，然后将paddingTop添加到正常布局。
     *       * 4. removeFakeStatusBarViewIfExist
     *       * 5. removeMarginTopOfContentChild
     *       * 6.添加OnOffsetChangedListener来更改statusBarView的alpha
     */
