...
class StatusBarCompatLollipop {
     ...
     * 3. set FitsSystemWindows to false
     */
    static void setStatusBarGradientColor(Activity activity, int drawableResource, boolean hideStatusBarBg) {
        Window window = activity.getWindow();
     ...
     */
    static void translucentStatusBarForImage(Activity activity, boolean hideStatusBarBackground, boolean textBlack) {
        Window window = activity.getWindow();
        ...
        if (hideStatusBarBackground) {
            window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
            window.setStatusBarColor(Color.TRANSPARENT);
            if (textBlack && Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
     ...
     */
    static void translucentStatusBar(Activity activity, boolean hideStatusBarBackground, View bgView, boolean textBlack) {
        Window window = activity.getWindow();
