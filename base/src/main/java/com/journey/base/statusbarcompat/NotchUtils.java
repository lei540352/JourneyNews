...
public class NotchUtils {
    ...
    public static int dip2px(float dpValue) {
        final float scale = BaseApplication.mApplication.getResources().getDisplayMetrics().density;
    ...
    public static int[] getHuaweiNotchSize() {
        int[] ret = new int[]{0, 0};
        try {
            ClassLoader cl = BaseApplication.mApplication.getClassLoader();
    ...
    public static int getXiaomiNotchSize(){
        ...
        //获取高度
        int resourceId = BaseApplication.mApplication.getResources().getIdentifier("notch_height", "dimen", "android");
        if (resourceId > 0) {
            dimensionPixelSize = BaseApplication.mApplication.getResources().getDimensionPixelSize(resourceId);
        }
        //获取宽度
    ...
    public static int getInt(String key) {
        ...
        if (isXiaomi()){
            try {
                ClassLoader classLoader = BaseApplication.mApplication.getClassLoader();
    ...
    public static boolean hasNotchAtOPPO() {
        return BaseApplication.mApplication.getPackageManager().hasSystemFeature("com.oppo.feature.screen.heteromorphism");
    }
    // 是否是小米手机
