...
import com.journey.news.widget.ProcessImageView;
...
public class RecommendActivitiesAdpater extends RecyclerView.Adapter<RecommendActivitiesAdpater.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.ivRecommendActivitiesPic.setProgress(data.get(position).getProcess());
    ...
    public void notifyDataImg(){
        for(int i = 0;i < myViewHolderList.size(); i++){
            Log.i("DataImg","顶顶顶顶顶大大大 ： "+data.get(myViewHolderList.get(i).position).getProcess());
            myViewHolderList.get(i).ivRecommendActivitiesPic
                    .setProgress(data.get(myViewHolderList.get(i).position).getProcess());
        }
    }

    public void notifyDataImgK(int k){
        if(myViewHolderList.size() > k && myViewHolderList.size() > k){
            Log.i("DataImg","顶顶顶顶顶大大大 ： "+data.get(myViewHolderList.get(k).position).getProcess());
            myViewHolderList.get(k).ivRecommendActivitiesPic
                    .setProgress(data.get(myViewHolderList.get(k).position).getProcess());
        }
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder
    {
        ...
        private ProcessImageView ivRecommendActivitiesPic;
        ...
        public MyViewHolder(View view)
        {
            ...
            ivRecommendActivitiesPic = (ProcessImageView) view.findViewById(R.id.iv_recommend_activities_pic);
